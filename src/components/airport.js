    ...
    <li>
        <div className="row d-block">
            ...
            <div className="collapse show" id="Airport-collapse" >
                <ul className="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                    <li><a href="/airport" className="link-body-emphasis d-inline-flex text-decoration-none rounded Active">- Airports</a></li>
...
<div className="col-lg-5 col-md-4">
    <div className="left">
        ...
        <button type="button" className="modal-btn " data-bs-toggle="modal" data-bs-target="#exampleModal"
            data-bs-whatever="@mdo">
            <a href='#' className="site-btn">Add New</a></button>
